    ...
    if (email && password) {
      signInWithEmailAndPassword(auth, email, password)
        .then((userCredential) => {
          ...
          if (email === "dangngocquy@gmail.com" && password === "dangngocquy" || email === "nguyenquanghuy@gmail.com" && password === "nguyenquanghuy" || email === "lethihagiang@gmail.com" && password === "lethihagiang") {
            window.location.href = "admin.html"; // Chuyển hướng tới admin.html
          } else {
            window.location.href = "index.html"; // Chuyển hướng tới index.html
          }
        })
        .catch((error) => {
          console.log(error);
